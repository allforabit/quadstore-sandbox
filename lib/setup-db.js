...
var quadstore_comunica_1 = require("quadstore-comunica");
/**
...
var setupDb = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                store = new quadstore_1.Quadstore({
                    backend: leveldown_1.default("./db"),
                    comunica: quadstore_comunica_1.newEngine(),
                    dataFactory: n3_1.DataFactory,
                });
                return [4 /*yield*/, store.open()];
            case 1:
                _a.sent();
