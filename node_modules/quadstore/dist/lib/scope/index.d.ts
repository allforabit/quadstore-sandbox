import { DataFactory, Quad, BlankNode } from 'rdf-js';
...
export declare class Scope {
    ...
    static addMappingToLevelBatch(scopeId: string, batch: AbstractChainedBatch<any, any>, originalLabel: string, randomLabel: string): void;
