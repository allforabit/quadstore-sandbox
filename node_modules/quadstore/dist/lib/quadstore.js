...
class Quadstore {
    constructor(opts) {
        ...
        this.defaultGraphMode = opts.defaultGraphMode || types_1.DefaultGraphMode.UNION;
    }
    fork(opts = {}) {
    ...
    async sparql(query, opts = utils_1.emptyObject) {
        this.ensureReady();
        return sparql_1.sparql(this, query, opts);
    }
    ...
    async sparqlStream(query, opts = utils_1.emptyObject) {
        this.ensureReady();
        return await sparql_1.sparqlStream(this, query, opts);
    }
    async initScope() {
        await this.ensureReady();
